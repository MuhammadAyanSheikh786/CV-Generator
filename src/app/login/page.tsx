        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-dark-400 mt-2">
              Sign in to access your dashboard and CV scans.
            </p>
          </div>

          <button
            onClick={handleGoogle}
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl border border-dark-600 bg-dark-800/50 hover:bg-dark-800 text-sm font-medium text-dark-200 transition-all mb-6"
          >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-dark-900 px-2 text-dark-500">or continue with email</span>
            </div>
          </div>
          ...
          <p className="text-center text-sm text-dark-400 mt-6">
            ...
            <Link href="/signup" className="text-lightning-500 hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </motion.div>
